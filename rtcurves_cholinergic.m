...
%           as default
%
%   See also RTCURVES, NBPERFORMANCECURVES, NBTUNINGCURVES, ULTIMATE_PSTH and
%   NBRESPONSESORTER.
...
addParameter(prs,'resdir',@(s)ischar(s))   % results directory
...
% PSTH
poppsth(cellids,g.align,'hit',g.normalization,g.doraster,g.issave,g.resdir);
poppsth(cellids,g.align,'fa',g.normalization,g.doraster,g.issave,g.resdir);
...
if issave
    ...
    fnm = [resdir '\meanSPSTH_' trialtype '.eps'];
    saveas(H,fnm)
end
close(H)
